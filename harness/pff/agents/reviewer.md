...
- Read the project knowledge and review the diff against it: the pff-architecture,
  pff-code-style, pff-design-system, and pff-domain skills. Report any diff that breaks a
  project convention.
