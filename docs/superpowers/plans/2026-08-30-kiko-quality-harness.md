# Plan: Kiko quality harness (Biome-adapted, LLM-guarding)
...
- **Spec:** `docs/superpowers/specs/2026-08-30-kiko-scaffold-and-harness-design.md` (Sections 4 and 5).
...
- [ ] Write the rule into `.npmrc`, excluding first-party packages:
  ...
  minimum-release-age-exclude[]=Kiko
  ```
