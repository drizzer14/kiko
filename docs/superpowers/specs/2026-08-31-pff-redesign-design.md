...
Bring PFF's look and interaction as close as possible to native Apple
...
`2026-08-30-pff-foundation-design.md`). The schema already supports
...
Owner: `pff:designer` (token map) + `pff:developer` (formatter).
