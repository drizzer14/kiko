# PFF — Scaffold and Agent Harness Design

## 1. Title and overview

Project name: PFF (Personal Finance Folder).
...
1. Run `npx @react-native-community/cli init PFF`. This creates a bare React Native app.
...
Package the harness as a local plugin in the repository, for example `harness/pff-harness/`. The plugin contains:
...
1. Remove the plugin directory (`harness/pff-harness/`).
